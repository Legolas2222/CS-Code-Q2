 ...
 */
 ...
 public class Tokenliste {
    ...
    */
   public void symbolAnfuegen(int index) {
     liste.append(new Integer(index));
   }
   ...
   public int naechstesToken() {
     if (liste.hasAccess()) {
       Integer tokenIndex = (Integer)(liste.getObject());
       liste.next();
       return symboltabelle.symbolVonIndex(tokenIndex);
     } else {
       return Token.leer;
     }
   }
