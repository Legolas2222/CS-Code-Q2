       ...
       do {
          ...
          switch (zustand) {
            case 0: if (zeichen == ' ' || zeichen == (char)9 || zeichen == '\n' ) {
                      ...
                      if (zeichenLeser.gibZeichen() == '*'){
                         boolean fertig = false;
                         while (fertig == false) {                   
                            while (zeichenLeser.gibZeichen() != '*') { 
                            }
                            if (zeichenLeser.gibZeichen() == '/'){
                               fertig = true;                                
                            }    
                      ...
                      zustand = 3;
                    } else if ( (zeichen >= 'a' && zeichen <= 'z') || (zeichen >= 'A' && zeichen <= 'Z') || zeichen == 'ä' || zeichen == 'ö' ||
                                 zeichen == 'ü' || zeichen == 'Ä' || zeichen == 'Ö' || zeichen == 'Ü') {
                      zustand = 4;
                      } else {
                      fehlerNr = 1;
                    }
            ...
            case 4: if (!((zeichen >= 'a' && zeichen <= 'z') || (zeichen >= 'A' && zeichen <= 'Z') || zeichen >= '0' && zeichen <= '9') || zeichen == 'ä' || zeichen == 'ö' ||
                        zeichen == 'ü' || zeichen == 'Ä' || zeichen == 'Ö' || zeichen == 'Ü'){
                      endzustand = true;
                    }
          }
